...
function eigenvaluearray=dirichletdeformedpeanutconvergencelist(K) % K is the number of the eigenfunction tested
    global alpha
    global l
    global m
    global N
    ...
    plotarray = [];
    eigenvaluearray = [];
    nvector = [1200,1000,800,600,400,300,200,150,100];
    reso=81;
    nlen = length(nvector);
    disp(nvector)
